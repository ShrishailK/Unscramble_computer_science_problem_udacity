...
print("\n".join(sorted(area_code_set)))


no_calls_bang = len(banglore_calls)
banglore_area_code = Counter(area_code)
count = banglore_area_code['080']
print("{} percent of calls from fixed lines in Bangalore are calls to other fixed lines in Bangalore".format(round(count/no_calls_bang *100,2)))